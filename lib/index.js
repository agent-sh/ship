...
// `binary` and `repoMap` are no longer re-exported from this index. They
// live canonically in agentsys/lib and are reached via lib/agentsys.js
// (the runtime resolver). Code that needs them should call:
//   const { binary, repoMap } = require('./lib/agentsys').get();
